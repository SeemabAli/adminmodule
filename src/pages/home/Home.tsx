    ...
    <section className="relative bg-base-200 w-full text-center py-20 px-6 md:px-12 lg:px-24">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="mt-4 text-lg text-base-content">
          ...
          transportation logistics with our integrated platform.
        </p>
  ...
  const features = [
    {
      ...
      description:
        "Track attendance, manage shifts, handle payroll, and maintain employee records seamlessly.",
    },
    {
      icon: <FiTruck className="text-4xl text-primary" />,
      title: "Transportation Logistics",
      description:
        "Monitor fleet location, schedule deliveries, track maintenance, and optimize transportation routes.",
    },
    {
      icon: <FiDollarSign className="text-4xl text-primary" />,
      title: "Financial Management",
      description:
        "Process payments, calculate taxes, generate financial reports, and forecast budget planning.",
    },
    {
      icon: <FiBarChart2 className="text-4xl text-primary" />,
      title: "Production Analytics",
      description:
        "Real-time insights into cement production metrics, quality control, and inventory management.",
    },
    {
      icon: <FiCalendar className="text-4xl text-primary" />,
      title: "Scheduling System",
      description:
        "Organize production schedules, delivery timelines, and employee shifts in one integrated calendar.",
    },
    {
      icon: <FiShield className="text-4xl text-primary" />,
      title: "Compliance Monitoring",
      description:
        "Ensure adherence to industry regulations, tax requirements, and safety standards at all times.",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-lg text-base-content/70 max-w-3xl mx-auto">
            Our comprehensive platform offers everything you need to manage your
            cement factory operations efficiently.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div
              key={index}
              className="bg-base-200 p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow dark:border"
            >
    ...
    <section className="py-20 px-6 md:px-12 lg:px-24 bg-base-200">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-lg text-base-content/70 max-w-3xl mx-auto">
            Benefit from our years of industry experience and purpose-built
            cement factory management solution.
          </p>
        </div>
          ...
          <div className="bg-base-200 p-8 rounded-xl shadow-sm border">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-3">
                <FiCheckCircle className="text-green-500 text-xl mt-1 flex-shrink-0" />
                <span className="text-base-content/70">
                  Optimize transportation routes saving on fuel costs
                </span>
              </li>
              <li className="flex items-start gap-3">
                <FiCheckCircle className="text-green-500 text-xl mt-1 flex-shrink-0" />
          ...
          <div className="bg-base-200 p-8 rounded-xl shadow-sm border">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <FiCheckCircle className="text-green-500 text-xl mt-1 flex-shrink-0" />
                <span className="text-base-content/70">
                  Accurate tax calculations preventing compliance issues
                </span>
              </li>
              <li className="flex items-start gap-3">
                <FiCheckCircle className="text-green-500 text-xl mt-1 flex-shrink-0" />
                <span className="text-base-content/70">
                  Real-time financial reporting for better cash flow management
                </span>
              </li>
              <li className="flex items-start gap-3">
                <FiCheckCircle className="text-green-500 text-xl mt-1 flex-shrink-0" />
    ...
    <section id="services" className="py-20 px-6 md:px-12 lg:px-24 bg-base-200">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-lg text-base-content/70 max-w-3xl mx-auto">
            Comprehensive solutions tailored specifically for cement factories
...
const Testimonials = () => {
  const testimonials = [
    {
      quote:
        "MB&CO transformed how we manage our cement factory. Their transportation tracking alone saved us 22% in logistics costs in the first quarter.",
      name: "Ahmed Hassan",
      role: "Operations Director, Global Cement Inc.",
    },
    {
      quote:
        "The employee management system handles our complex shift schedules perfectly. Payroll that used to take days now happens with a few clicks.",
      name: "Sarah Johnson",
      role: "HR Manager, Concrete Solutions Ltd.",
    },
    {
      quote:
        "Tax compliance was always a headache until we implemented MB&CO's financial management system. Now we're audit-ready year-round.",
      name: "Michael Lee",
  ...
  return (
    <section
      id="testimonials"
      className="py-20 px-6 md:px-12 lg:px-24 bg-base-200"
    >
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-base-content">
          ...
          <p className="mt-4 text-lg text-base-content/70 max-w-3xl mx-auto">
            Hear from cement industry professionals who've transformed their
...
const FAQ = () => {
  const faqs = [
    ...
    {
      question:
        "Is the platform customizable for different sizes of cement factories?",
      answer:
    ...
    <section id="faq" className="py-16 px-4 md:px-12 lg:px-24 bg-base-200">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <p className="mt-4 text-lg text-base-content">
            Get answers to common questions about our cement factory management
            solutions.
          </p>
        </div>
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            <div
              key={index}
              className="collapse collapse-arrow bg-base-200 dark:border shadow-lg rounded-lg"
            >
              <input type="checkbox" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <p className="text-lg text-base-content/70 mb-8">
              Ready to transform your cement factory operations? Contact us
              today for a personalized demo or to discuss your specific needs.
            </p>
          ...
          <div className="bg-base-100 p-8 rounded-xl shadow-md">
            ...
            <form className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-primary text-white px-6 py-3 rounded-lg font-medium hover:bg-primary/80 transition"
              >
                Send Message
              </button>
            </form>
